    ...
    return (
        <div className={`${cl.containerWrapper} ${clAdaptive.containerWrapper_ProjectCard__adaptive}`}>
            <div className={cl.preview}>
                <img loading='lazy' src={ContentCard?.imgSrc} alt={ContentCard?.imgAlt} />
                <img loading='lazy' className={cl.imgBacground} src={ContentCard?.imgSrc} alt={ContentCard?.imgAlt} />
            </div>
            <div className={cl.containerWrapper__Padding}>
                ...
                <div className={cl.container_link}>
                    {ContentCard.SPA ?
                        <>
                            <MyLink href={ContentCard?.linkLivePreview} to='/Scroll_3D' rel="noreferrer">
                            ...
                            <MyLink href={ContentCard?.linkViewCode} to='Scroll_3D' rel="noreferrer">
